...
// Jeremy Tammik, 2009-02-12: added DLL interface and implemented .NET client
//
//#if defined _MSC_VER
...
__declspec( dllexport ) char * getString64FromGuid( const GUID *pGuid, char * buf, int len );
__declspec( dllexport ) BOOL getGuidFromString64( const char *string, GUID *pGuid );
